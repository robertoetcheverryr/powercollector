  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'FileVersion', u'1.0.14'),
        StringStruct(u'InternalName', u'powercollector'),
        StringStruct(u'LegalCopyright', u'© 2021 Roberto Etcheverry uses code © 2020 by Hackers and Slackers'),
        StringStruct(u'OriginalFilename', u'powercollector.exe'),
        StringStruct(u'ProductName', u'powercollector'),
        StringStruct(u'ProductVersion', u'1.0.14')])
      ]),
